...
| ssm\_key\_artifact\_export\_access\_key\_id\_1 | The AWS SSM Parameter Store parameter that contains the AWS access key of the IAM user that can write to the first assessment artifact export bucket (e.g. "/assessment\_artifact\_export/access\_key\_id\_1"). | `string` | `"/assessment_artifact_export/access_key_id"` | no |

...
#
# For: DevOps ssh access from Guacamole instance to Debian desktop
# instance
...
#
# For: Assessment team VNC access from Guacamole instance to Debian
# desktop instance
...
# Allow egress from Debian desktop instances via Nessus web GUI port
# (8834)
#
# For: Operator Nessus web access from Debian desktop instances
#
# NOTE: This rule will only be created if there is at least one Nessus
# instance and at least one Debian Desktop instance.
